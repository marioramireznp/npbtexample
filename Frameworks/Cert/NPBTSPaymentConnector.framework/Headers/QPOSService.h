...
typedef NS_ENUM(NSInteger, EmvOption1)
{
...
typedef NS_ENUM(NSInteger, TransactionResult1) {
...
typedef NS_ENUM(NSInteger, TransactionType1) {
...
-(void) onRequestTime;
-(void) onRequestTransactionResult: (TransactionResult1)transactionResult;
...
-(void) onDHError: (Error)errorState;//replace function onError
...
@property (nonatomic, assign) EmvOption1 emvOption;
...
-(void) doEmvApp: (EmvOption1)aemvOption;
-(void) cancelSetAmount;
-(void) setAmount: (NSString *)aAmount aAmountDescribe:(NSString *)aAmountDescribe currency:(NSString *)currency transactionType:(TransactionType1)transactionType;
...
-(void) setAmount: (NSString *)aAmount aAmountDescribe:(NSString *)aAmountDescribe currency:(NSString *)currency transactionType:(TransactionType1)transactionType posDisplayAmount:(BOOL)flag;
